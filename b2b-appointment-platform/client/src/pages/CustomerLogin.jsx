...
export default function CustomerLogin() {
  ...
  //     if (mode === "login" && x.user.role !== "CUSTOMER")
  //       throw new Error("Please use a customer account to book appointments.");
      ...
      <div className="mx-auto max-w-md">
        ...
        <div className="mt-4 rounded-2xl bg-white p-8 shadow-sm ring-1 ring-slate-200">
          ...
          <p className="mt-2 text-sm text-slate-500">
            You only need an account when you are ready to book.
          </p>
          {error && (
